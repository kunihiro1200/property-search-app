...
async function main() {
  console.log('🔍 AA13529の同期処理をデバッグします...\n');
  ...
  // 5. updateSingleSellerで設定される値を確認
  console.log('\n📊 Step 5: updateSingleSellerで設定される値を確認');
  const columnMapper = new ColumnMapper();
  const mappedData = columnMapper.mapToDatabase(row);
  
  console.log('  mappedData.inquiry_date:', mappedData.inquiry_date);
  console.log('  mappedData.inquiry_year:', mappedData.inquiry_year);
