...
- **営担が通常スタッフ（NORMAL_STAFF_INITIALS）に含まれる** ← **重要**
- 訪問日（visitDate）が今日以降

**通常スタッフ（10名）**: K, Y, I, 林, 生, U, R, 久, 和, H
...
**重要**: 
- 訪問予定は他のステータスより優先される
- **通常スタッフ以外（事務、GYOSHA、外すなど）は訪問予定に含まれない**
...
**重要**: **通常スタッフ以外（事務、GYOSHA、外すなど）は訪問済みに含まれない**
...
| ステータス | 条件 | 色 |
|-----------|------|-----|
| 訪問予定 | 営担あり + **通常スタッフ** + 訪問日が今日以降 | 緑 |
| 訪問済み | 営担あり + **通常スタッフ** + 訪問日が昨日以前 | 青 |
...
**更新履歴**:
- 2026年2月1日: 訪問予定/訪問済みに「通常スタッフのみ」フィルタリングを追加
